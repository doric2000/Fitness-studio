...
public class NotificationService {
    private Gym gym; // Reference to the Gym instance

    /**
     * Constructs a NotificationService with a reference to the Gym instance.
     *
     * @param gym The Gym instance used for retrieving sessions and clients.
     */
