...
public class Client extends Person implements Observer {
    ...
    /**
     * Constructs a new Client using a Person object.
     *
     * @param person The Person object containing basic client information.
     */
     ...
     * This method is called when the client is notified as an Observer.
     *
