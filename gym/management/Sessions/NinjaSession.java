...
public class NinjaSession implements Session {
    ...
    /**
     * Constructs a new gym.management.Sessions.NinjaSession with the specified date, forum type, and instructor.
     *
     ...
     *
     * @param client The gym.customers.Client to register for the session.
     */
     ...
     *
     * @param client The gym.customers.Client whose balance is being checked.
