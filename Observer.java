/**
 * The Observer interface defines a contract for objects that need to be notified of updates or changes
 * It follows the Observer design pattern, where observers listen for messages or notifications
